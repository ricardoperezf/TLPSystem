...
$page = isset($_GET['p'])?$_GET['p']:'';
    ...
    $query = $DBconexion->prepare("SELECT id, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, tipo_documento, cedula, direccion, telefono, correo FROM director ORDER BY primer_nombre");
    $query->execute();
