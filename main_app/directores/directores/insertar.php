...
if(!empty($_POST))
{
 $output = '';
    ...
    $query = "
    INSERT INTO director(primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, tipo_documento, cedula, direccion, telefono, correo, tipo_usuario)  
     VALUES('$primerNombre', '$segundoNombre', '$primerApellido', '$segundoApellido', '$tipoDocumento', '$cedula', '$direccion', '$telefono', '$correo', 'Director')
    ";
