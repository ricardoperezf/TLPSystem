...
require_once 'config.php';
    ...
    $query = $DBconexion->prepare("SELECT id, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, tipo_documento, cedula, direccion, telefono, correo, tipo_equipo FROM estudiante ORDER BY tipo_equipo");
    $query->execute();
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="editLabel-<?php echo $row['id'] ?>">Editar estudiante</h4>
                        </div>
                        <form>
