                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-xs-12">
                            <h1>Estudiantes</h1>
                            <p>En esta sección podrás ingresar todos los estudiante que reciben clases en TLP.</p>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Detalle del estudiante</h4>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="addLabel">Insertar estudiantes</h4>
                                </div>
