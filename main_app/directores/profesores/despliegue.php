...
require_once 'config.php';
    ...
    $stmt = $dbcon->prepare("SELECT * FROM profesor ORDER BY tipo_equipo ASC");
    $stmt->execute();
                        ...
                        <form>
                            <div class="modal-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="primerNombre-<?php echo $row['id'] ?>" value="<?php echo $row['primer_nombre'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                <input type="text" class="form-control" id="segundoNombre-<?php echo $row['id'] ?>" value="<?php echo $row['segundo_nombre'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                <input type="text" class="form-control" id="primerApellido-<?php echo $row['id'] ?>" value="<?php echo $row['primer_apellido'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                <input type="text" class="form-control" id="segundoApellido-<?php echo $row['id'] ?>" value="<?php echo $row['segundo_apellido'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="time">Tipo documento</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
                                                <select id="tipoDocumento-<?php echo $row['id'] ?>" name="tipoDocumento" class="form-control" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
                                                <input type="text" class="form-control" id="cedula-<?php echo $row['id'] ?>" value="<?php echo $row['cedula'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" required id="direccion-<?php echo $row['id'] ?>" placeholder="Dirección"><?php echo $row['direccion'] ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="telefono-<?php echo $row['id'] ?>" value="<?php echo $row['telefono'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email-<?php echo $row['id'] ?>" value="<?php echo $row['correo'] ?>" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
                                                <select id="tipoEquipo-<?php echo $row['id'] ?>" name="td" class="form-control" required>
