...
//$queryPrincipal = $DBconexion->prepare("SELECT tipo_equipo FROM sub_director WHERE CONCAT(primer_nombre, ' ', primer_apellido) = '$usuario'");
//$queryPrincipal->execute();
//$rowPrincipal = $queryPrincipal->fetch(PDO::FETCH_ASSOC);
